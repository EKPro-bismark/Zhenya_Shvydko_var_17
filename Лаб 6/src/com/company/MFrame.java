...
public class MFrame extends JFrame {
    ...
    MFrame(){
        ...
        Singleton.getVector().setHabitat(habitat);
        ...
        JMenuItem inputDB = new JMenuItem("Выгрузить в базу данных все объекты");
        JMenuItem inputCatDB = new JMenuItem("Выгрузить в базу данных кошек");
        JMenuItem inputDogDB = new JMenuItem("Выгрузить в базу данных собак");
        JMenuItem outputDB = new JMenuItem("Загрузить из базы данных все объекты");
        JMenuItem outputCatDB = new JMenuItem("Загрузить из базы данных кошек");
        JMenuItem outputDogDB = new JMenuItem("Загрузить из базы данных собак");
        JMenuItem server = new JMenuItem("Обмен");
        ...
        mainMenu.add(inputDB);
        mainMenu.add(inputCatDB);
        mainMenu.add(inputDogDB);
        mainMenu.add(outputDB);
        mainMenu.add(outputCatDB);
        mainMenu.add(outputDogDB);
        mainMenu.add(server);
        Bar.add(mainMenu);
        setJMenuBar(Bar);
        ...
        inputDB.addActionListener(new ActionListener() {
            @Override
        ...
        inputCatDB.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                InputDBCats();
            }
        ...
        inputDogDB.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                InputDBDogs();
            }
        ...
        outputCatDB.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    OutputDB(true);
        ...
        outputDogDB.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    OutputDB(false);
        ...
        server.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
               swapDialog = new SwapDialog(MFrame.this);
            }
        });
    ...
    public void InputDB() {
        ...
        for(int i = 0; i < Singleton.getVector().getArray().size(); i++) {
            dbHandler.addObj(Singleton.getVector().getArray().get(i));
        }
    }

    public void InputDBCats() {
        DB dbHandler = new DB();
        for(int i = 0; i < Singleton.getVector().getArray().size(); i++) {
            if(Singleton.getVector().getArray().get(i) instanceof Cat)
                dbHandler.addCat(Singleton.getVector().getArray().get(i));
        }
    }

    public void InputDBDogs() {
        DB dbHandler = new DB();
        for(int i = 0; i < Singleton.getVector().getArray().size(); i++) {
            if(Singleton.getVector().getArray().get(i) instanceof Dog)
                dbHandler.addDog(Singleton.getVector().getArray().get(i));
        }
    }
